...
I should also (not to add more programs to learn) that there are often already great tools out there to vett these intermediate data files and look for known pathologies!
