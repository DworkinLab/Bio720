...
- create a copy of the data, but without the "gene column"
- turn rownames into gene names

```{r}
rna_counts2 <- rna_counts[, -1]
...
- copy all sample names to a variable
- split sample names based on delimiters
- check metadata split appropriately
- give appropriate variable names
- give rownames the samplenames

```{r}
sample_names <- colnames(rna_counts2)

split_variables_temp <- stringr::str_split_fixed(string = sample_names, 
                                pattern = "_", n = 7)
```
