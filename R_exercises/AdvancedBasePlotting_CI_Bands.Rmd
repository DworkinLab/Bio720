...
The easiest way to use transparency in `base R` plots is to use the `rgb()` when specifying the functions. The first three arguments are red, green and blue. The 4th argument "alpha" is the transparency. This is what I now use.

Below I describe another way which is more general using hexmode.
